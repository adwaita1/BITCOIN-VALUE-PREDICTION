...
def process_tweets_from_file(fin, fout):
    ...
    reader = csv.reader(open('/home/amit/Desktop/Sentiment_analysis/Bitcoin-price-prediction-model-master/coindesk-bpi-USD-close_data-2010-07-18_2018-06-08.csv', 'r'))
    d = {}
    for row in reader:
        k, v = row
        print(k)
