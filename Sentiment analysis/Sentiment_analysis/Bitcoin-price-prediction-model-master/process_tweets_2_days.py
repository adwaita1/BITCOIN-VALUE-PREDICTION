...
def process_tweets_from_file(fin, fout):
    ...
    reader = csv.reader(open('/home/amit/Desktop/Sentiment_analysis/Bitcoin-price-prediction-model-master/coindesk-bpi-USD-close_data-2010-07-18_2018-06-09.csv', 'r'))
    d = {}
    for row in reader:
        k, v = row
        print(k)
    ...
    with open(fin) as f:
        for line in f:
            ...
            try:
                ...
                print(this_date)
                next_date = this_date + datetime.timedelta(days=2)
                j['price'] = 0
